...
function userRoutes(server) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        server.put("/update-password", { preHandler: [server.authenticate] }, user_controller_1.updatePasswordHandler);
        server.get("/", { preHandler: [server.authenticate] }, user_controller_1.getUsersHandler);
    });
}
